    ...
    return (
        <section className="flex justify-center items-center h-screen">
            ...
            <form className="max-w-sm">
                ...
                <h2 className="text-3xl font-bold mt-1">Login to your account</h2>
                <p className="text-slate-400 text-sm">Welcome back! select method to login</p>
                ...
                <div className="flex justify-center items-center gap-4 mb-5">
                    ...
                    <span className="text-slate-400 text-sm whitespace-nowrap">Or login with email</span>
                    <hr className="w-full text-black" />
                </div>
